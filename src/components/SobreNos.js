...
const BannerContainer = styled.div`
  ...
  height: 300px; /* Altere a altura conforme necessário */
  display: flex;
  align-items: center;
...
const SobreNosContainer = styled.div`
  padding: 20px;
  text-align: center;
  font-family: 'Poppins', sans-serif; /* Garantindo a consistência da fonte */
`;
...
const AboutText = styled.p`
  ...
  margin: 10px 0;
  line-height: 1.5;
  color: black; /* Mantendo a cor do texto consistente */
`;
